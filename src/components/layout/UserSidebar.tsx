...
const NAV: NavItem[] = [
  { href: "/user/dashboard", label: "Dashboard", iconSrc: "/figma/icons/dashboard.svg" },
  { href: "/user/search", label: "Search Hotels", iconSrc: "/figma/icons/search.svg" },
  { href: "/user/nearby", label: "Nearby Hotels", iconSrc: "/figma/icons/location.svg" },
  { href: "/user/bookings", label: "My Bookings", iconSrc: "/figma/icons/hotel.svg" },
  { href: "/user/wallet", label: "Wallet", iconSrc: "/figma/icons/wallet.svg" },
  { href: "/user/orders", label: "Orders", iconSrc: "/figma/icons/hotel.svg" },
  { href: "/user/messages", label: "Messages", iconSrc: "/figma/icons/notification.svg" },
  { href: "/user/profile", label: "My Profile", iconSrc: "/figma/icons/identity-card-sm.svg" },
];
